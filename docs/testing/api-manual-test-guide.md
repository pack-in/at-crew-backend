...
- **ArtworkRole**: `TOTAL_ARTWORK`, `ARTWORK`, `ADAPTATION_STORYBOARD`, `STORYBOARD`, `DIRECTION`, `LINEART`, `SKETCH`, `COLORING`, `BASE_COLOR`, `TONE_WORK`, `POST_PROCESSING`, `PANEL_DECORATION`, `LETTERING`, `FULL_COLOR`, `THREE_D_MODELING`, `MATERIAL_MAKING`, `MATERIAL_PLACEMENT`, `BACKGROUND`, `WEBNOVEL_COVER`, `CHARACTER_DESIGN`, `CHARACTER_SHEET`, `TYPOGRAPHY`, `BROADCAST_THUMBNAIL`
