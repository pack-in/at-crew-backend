...
**게시글 행과 지원 내역은 지우지 않는다.** 지원 내역은 지원자의 개인정보이고 보관 기간은 개인정보처리방침에
적어 동의를 받아야 하는 값이라, 방침이 정해진 뒤에 다룬다(#200). 참고로 법·업계 관행은 "혹시 몰라 계속 보관"이
아니라 "정해진 기간 뒤 파기"이고, 5년 보관 의무는 결제·계약 기록에 붙지 지원 내역에는 붙지 않는다.
