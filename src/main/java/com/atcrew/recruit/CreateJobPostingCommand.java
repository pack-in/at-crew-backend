...
/**
 * 구인글 작성 커맨드 (docs/design/recruit-module-design.md §2.1, §4.1).
 * {@code submit=true}이면 DRAFT로 저장 직후 즉시 PENDING 제출까지 처리한다.
 */
public record CreateJobPostingCommand(
        ...
        boolean submit                          // true면 저장 직후 PENDING 제출까지 처리
) {
}
