...
public enum RecruitErrorCode {
    ...
    APPLICATION_NOT_FOUND(HttpStatus.NOT_FOUND, "존재하지 않는 지원 내역입니다"),
    ...
    // 상한값은 media 모듈이 Worker와 공유한다(MediaConstraints.MAX_ORIGINAL_BYTES) — 문구의 20MB는 그 값이다
    IMAGE_TOO_LARGE(HttpStatus.BAD_REQUEST, "이미지 한 장의 용량은 20MB를 넘을 수 없습니다");
