...
class AuthController {
    ...
    @CommonApiResponses
    @PostMapping("/login")
    public com.atcrew.common.ApiResponse<AuthInfo> login(@RequestBody @Valid LoginRequest request) {
        return com.atcrew.common.ApiResponse.success(authService.login(request.firebaseIdToken()));
    }
    ...
    @CommonApiResponses
    @PostMapping("/refresh")
    public com.atcrew.common.ApiResponse<AuthInfo> refresh(@RequestBody @Valid RefreshRequest request) {
        return com.atcrew.common.ApiResponse.success(authService.refresh(request.refreshToken()));
    }
}
