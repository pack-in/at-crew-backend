...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        return ResponseEntity.badRequest().body(new ErrorResponse("COMMON_INVALID_INPUT", message));
    }
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        return ResponseEntity.badRequest()
                .body(new ErrorResponse("COMMON_INVALID_INPUT", "요청 본문의 형식이 올바르지 않습니다"));
    }
    ...
    public ResponseEntity<ErrorResponse> handleException(Exception e) {
        ...
        return ResponseEntity.internalServerError()
                .body(new ErrorResponse("COMMON_INTERNAL_SERVER_ERROR", "서버 내부 오류가 발생했습니다"));
    }
}
