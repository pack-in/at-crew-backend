...
class MemberMapper {
    ...
    static MemberProfileInfo toProfileInfo(Member member) {
        return new MemberProfileInfo(
                ...
                member.getDrawingStyles(),
                member.getWorkPace(),
                member.getAvailableStartPeriod(),
                member.getDesiredRoles(),
                member.getDesiredGenres(),
                member.getDesiredEmploymentTypes(),
                member.getDesiredWorkLocation(),
                member.getFeedbackPreferences(),
                member.getDesiredMinimumGuarantee(),
                member.getDesiredAnnualSalary(),
                member.getCustomTags(),
